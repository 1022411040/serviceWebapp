          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-12">
                Whether you have a clear vision or just an idea, we're here to help bring it to life. Reach out and let's discuss how we can work together.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@devagency.com</p>
                    <p className="text-gray-600">support@devagency.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Business Park, Andheri East</p>
              ...
              <div className="mt-12 h-64 bg-gray-200 rounded-2xl overflow-hidden">
                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.555589643652!2d72.8507356!3d19.1168197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c9c1b4b3b4b3%3A0x4b3b4b3b4b3b4b3b!2sAndheri%20East%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
            ...
            {[
              {
                ...
                a: "We can typically start within 3-5 business days after initial consultation and agreement."
              },
              {
                q: "Do you offer revisions?",
                a: "Yes, we offer revisions based on your package. We want you to be completely satisfied."
              },
              {
                q: "What payment methods do you accept?",
                a: "We accept bank transfers, credit/debit cards, and UPI payments. Installments available for larger projects."
              },
              {
                q: "Do you provide ongoing support?",
                a: "Absolutely! We offer maintenance packages and ongoing support for all our projects."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
